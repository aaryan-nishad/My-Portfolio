...
function Experience() {
  return ( 
    <section id='experience' className='relative overflow-hidden flex flex-col text-gray-600 body-font'>
        <div className='absolute top-[100px] left-64 inset-x-0 flex items-start justify-center'>
            ...
            <div className='container mx-auto flex px-5 py-24 md:flex-row flex-col items-center'>
                <div data-aos="fade-right" data-aos-delay='400' className='relative lg:max-w-lg lg:w-full md:w-1/2 w-5/6 md:mb-0'>
                  <div className='md:h-[450px] h-[400px] md:w-[300px] w-[300px] md:right-36 bg-gradient-to-r from-orange-600 via-yellow-500 to-red-400
                  absolute rounded-md transform rotate-3 -top-8 shadow[0_0_40px_rgba(225,165,0,0.7)] z-0'></div>
                
                <img src={img_experience} alt="" className='object-cover md:w-[300px] md:h-[450px] object-center rounded relative z-10 '/>
                </div>
        ...
        <p className='mb-8 text-white leading-relaxed'> I completed a 6-month internship at Hanumant Technologies in 2024, 
          where I gained hands-on experience in backend development, API integration, and building server-side logic to support 
          dynamic web applications.</p>

        <h2 className='title-font font-bold text-white sm:text-2xl'> 2025:</h2>

        <p className='mb-8 text-white leading-relaxed'> Currently in 2025, I'm working on various projects at 7 Techies, 
          a Gurgaon-based company specializing in IT solutions. Here, I'm involved in developing tech systems for sports events 
          and other IT-related services across different domains.</p>
        </div>
        </div>
    </section>
  )
