...
function Hero() {
    return (
        ...
        to-red-400 absolute rounded-full transform rotate-12 -top-20 shadow-[0_0_40px_rgba(255, 165, 0, 0.7)]'>
            ...
            relative'>
                        <img src={hi} data-aos='fade-up' data-aos-delay='400' className='absolute top-[350px left-44 md:top-[-30px] md:left-[450px] transform
                -translate-x-1/2 -translate-y-1/2 w-20 h-20'/>
                        ...
                        <div className='flex justify-center'>
                            <a href={CV} download>
                                ...
                                hover:bg-orange-600 hover:shadow-[0_0_40px_rgba(255,165,0,0.7)]
